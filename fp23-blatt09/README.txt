...
## Set the environment variable 'PATH_TO_FX' that points to whereever you stores the JavaFX library. Here, we for example use "C:\Program Files\Java\javafx-sdk-17.0.2\lib" (MS windows) and "/home/<user>/Java/javafx-sdk-17.0.2/lib" (Unix)
